...
class Config:
  ...
  if ENV:
    ...
    BOT_TOKEN = '6140209276:AAFO_epd5fCkqAVC9TJCprpFNeCEVABrouk' # Get it from https://t.me/BotFather
    APP_ID = '9548711' # Get it from my.telegram.org/apps
    API_HASH = '4225fbfa50c5ac44194081a0f114bdd1' # Get it from my.telegram.org/apps
